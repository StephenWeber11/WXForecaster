...
<div class="grid-container">
    <div class="grid-100" id="forecast101">
        ...
        <div class="grid-75">
            ...
            <div id="italics">
                <h4><span class="large_quote">"</span>&nbsp;&nbsp;How to read & understand MOS data</h4>
                <br/>
                ...
                <br/>
                <p>When both the POP gets over 40% and the QPF is 3 or higher on several models, then a significant precipitation event is looking much more favorable. <span class="large_quote">"</span></p>

                <br/>
            </div>
            <p class="referenceRight"><span id="large_source">SOURCE: </span>&copy; Meteorologist Jeff Haby @ <a href="http://theweatherprediction.com">The Weather Prediction</a></p>
        </div>
    </div>
</div>
